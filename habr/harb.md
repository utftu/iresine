...
Ответ зависит от того, где располагаются сущности без идентификатора.
* В данном случае, посколько они располагаются внутри сущности, которая имеет идентификатор, они будут храниться вместе с user и считаться его частью. 
Любое их изменение привет к изменению user и оповещению всех подписчиков.
