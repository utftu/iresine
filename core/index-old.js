import {setAdd, setRightUniq} from './utils';
...
class Store {
  ...
  #insertModelOut(storeId, template, parentModelIds) {
    ...
    currentModel.template = this.#parse(template, {
      currentModelId: currentModel.modelId,
      omitNextModel: true,
      storeIds: childrenModelIds,
    });
    const childrenIdsToCheck = setRightUniq(childrenModelIds, currentModel.children);
